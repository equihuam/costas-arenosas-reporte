...
=======
3.  **Descripción del proyecto y marco teórico**
>>>>>>> 0d1c9a685e0dfa699f1a358c3fe5de14fc5ceac9
...
tableros <- miroBoards(servMiro = "costas", user = "miguel")
tableros[, c("name", "id")]
...
datos_miro <- getMiro(servMiro = "costas", user = "miguel",
                        board = tablero_tr)
