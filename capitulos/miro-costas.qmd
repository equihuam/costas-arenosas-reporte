...
datos_miro$nodes$text <- stringr::str_replace(datos_miro$nodes$text, pattern = "http", 
                                              replacement = "\nhttp")
datos_miro$nodes$text <- stringr::str_replace(datos_miro$nodes$text, 
                                              pattern = "(?<=[a-z])([A-Z])", 
                                              replacement = " \\1")
datos_miro$nodes$text <- stringr::str_replace(datos_miro$nodes$text, 
                                              pattern = "Suelos sueltos", 
                                              replacement = "\nSuelos sueltos")
datos_miro$nodes$text <- stringr::str_replace(datos_miro$nodes$text, 
                                              pattern = "VALERIA", 
                                              replacement = "\n- VALERIA\n")
datos_miro$nodes$text <- stringr::str_replace(datos_miro$nodes$text, 
                                              pattern = "Eventos de vientos extremos.", 
                                              replacement = "\nSuelos sueltos")
datos_miro$nodes$text <- stringr::str_replace(datos_miro$nodes$text, 
                                              pattern = "segundos\\)En versión", 
